...
def hardware_inventory():
    ...
    hardware_dict.update(two_column_dict('CPU', clean_string(bash('lscpu'))))

    hardware_dict.update(two_column_dict('Memory', clean_string(bash('cat /proc/meminfo'))))
    ...
    # TODO
    #hardware_dict.update(bash('lshw')

    # TODO
    #hardware_dict.update(bash('Show hardware interrupts: \n', 'cat /proc/interrupts'))
...
def network_info():
    ...
    for dev in netdevs.keys():
        network_dict.update('RX and TX bytes for each of the network devices: \n'
...
def collect_inventory():
    ...
    inventory_dict.update(dict({'Date': time_stamp()}))
